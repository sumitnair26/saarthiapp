...
/* contest_question Table contains Q&A */
  ...
  `option_1` text COLLATE utf8_unicode_ci  DEFAULT NULL,
  `option_2` text COLLATE utf8_unicode_ci  DEFAULT NULL,
  `option_3` text COLLATE utf8_unicode_ci  DEFAULT NULL,
  `option_4` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `correct_answer` text COLLATE utf8_unicode_ci DEFAULT NULL,
